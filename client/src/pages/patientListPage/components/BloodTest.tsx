...
const BloodTest = ({ pid, date }: { pid: string; date: string }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (confirmResult) {
            ...
            await api
                .post(`inquiry/${pid}/bloodTest`, BloodTestScore)
                .then((res) => {
                    ...
                    <div className="inquiry-table-BloodTest-content-row">
                        <div className="inquiry-table-BloodTest-content-row-ACHR">
                            ...
                            <div style={{ position: "relative" }}>
                                ...
                                {!BloodTestScore.ACHR && (
                                    <div className="BloodTest-placeholder">
                                        (nmol/mL)
                                    </div>
                                )}
                            </div>
