    ...
    const searchSubmit = (e: React.FormEvent) => {
        ...
        fixedPatients?.forEach((eachPatient) => {
            const age =
                ...
                new Date(eachPatient.info.DOB).getFullYear();
            if (
            ...
            >
                ...
                <DialogContent sx={{ margingTop: "5vh" }}>
                    ...
                    <TextField
                        ...
                        value={
                            addPatient!.otherHospitalRecord.recentlyDate || ""
                        }
                        InputLabelProps={{
                            shrink: true,
                        }}
            ...
            >
                ...
                <DialogContent sx={{ marginTop: "5vh" }}>
                    ...
                    <TextField
                        ...
                        name="otherHospitalRecord.recentlyDate"
                        defaultValue={
                            updatePatient?.otherHospitalRecord.recentlyDate
                        }
                        InputLabelProps={{
                            shrink: true,
                        }}
                    ...
                    <TextField
                        ...
                        name="otherHospitalRecord.totalTimes"
                        defaultValue={
                            updatePatient?.otherHospitalRecord.totalTimes
                        }
                        sx={{
                            "& .MuiOutlinedInput-input": {
                                background: "#E0F4FF",
