...
const Left = ({ info }: { info: Info }) => {
    ...
    const currentAge =
        currentDate.getFullYear() - parseInt(info.DOB.slice(0, 4));
        ...
        <div className="inquiry-components-left-bg">
            <div className="inquiry-components-left">
                <div className="inquiry-components-left-header">
                    ...
                    <div className="inquiry-components-left-title">
                        基本資料
                    </div>
                        ...
                        <div className="inquiry-components-left-footer-basicdata-context">
                            ...
                            <div className="inquiry-components-left-footer-basicdata-context-right">
                                <input
                                    ...
                                    readOnly={readOnly}
                                    defaultValue={
                                        info.otherHospitalRecord.recentlyDate
                                    }
                                ></input>
                            </div>
                        </div>
                        <div className="inquiry-components-left-footer-basicdata-context">
                            ...
                            <div className="inquiry-components-left-footer-basicdata-context-right">
                                <input
                                    ...
                                    readOnly={readOnly}
                                    defaultValue={
                                        info.otherHospitalRecord.totalTimes
                                    }
                                ></input>
                            </div>
                        </div>
