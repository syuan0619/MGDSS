...
import { PATIENT, QOL } from "../../types/Schema";
...
const VisitPage = () => {
    ...
    const cardRotate = (tableName: string) => {
        ...
        document
            .getElementById(tableName)
            ?.style.setProperty("--rotate-back", "0");
    };
