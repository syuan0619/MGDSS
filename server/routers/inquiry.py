...
from mongoDB.connectDB import updatePatient
...
async def inquiry_visit(patientId: str, table: patient.Visit):
    try:
...
async def inquiry_thymus(patientId: str, table: patient.Thymus):
    try:
...
async def inquiry_bloodTest(patientId: str, table: patient.BloodTest):
    try:
...
async def inquiry_QOL(patientId: str, table: patient.QOL):
    try:
...
async def inquiry_QMG(patientId: str, table: patient.QMG):
    try:
...
async def inquiry_MG(patientId: str, table: patient.MG):
    try:
...
async def inquiry_ADL(patientId: str, table: patient.ADL):
    try:
...
async def inquiry_EMG(patientId: str, table: patient.EMG):
    try:
