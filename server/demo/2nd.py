...
image = Image.open(r'C:\Users\曾澤軒\Desktop\Git\MDGSS\server\images\1.png')
...
for i, (w, h, x, y) in enumerate(crop_dimensions, start=1):
    ...
    img = cv2.resize(img, (int(img.shape[1] * new_dpi[0] / img.shape[0]), int(img.shape[0] * new_dpi[1] / img.shape[1])))  
